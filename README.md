...
```javascript
maxn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-maxn@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-maxn@v0.2.0-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-maxn/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/math-base-special-maxn/actions/workflows/test.yml?query=branch:v0.2.0
...
[deno-readme]: https://github.com/stdlib-js/math-base-special-maxn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/math-base-special-maxn/tree/umd
[umd-readme]: https://github.com/stdlib-js/math-base-special-maxn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/math-base-special-maxn/tree/esm
[esm-readme]: https://github.com/stdlib-js/math-base-special-maxn/blob/esm/README.md
